...
const PostDetails = () => {
  ...
  const fetchPosts = async () => {
    try {
      const response = await axios.get(
        `https://khatabook-backend.onrender.com/hissab/post/${id}`,
  ...
  const deletefnc = () => {
    ...
    try {
      axios.delete(`https://khatabook-backend.onrender.com/hissab/delete/${id}`, {
        withCredentials: true,
      });
  ...
  const handleShare = () => {
    const shareableLink = `https://khatabook-backend.onrender.com/shared/${post._id}`;
